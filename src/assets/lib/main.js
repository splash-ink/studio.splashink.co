...
function init_scroll_navigate() {
    ...
    menu_links.each(function () {
        var currLink = $(this);
        if (currLink.attr("routerLink").indexOf("#") > -1 && $(currLink.attr("routerLink")).length > 0) {
...
$(document).ready(function () {
    ...
    if ($('#instaFeed-style1').length != 0) {
        var instaFeedStyle1 = new Instafeed({
            ...
            userId: 6988054982,
            limit: '8',
            accessToken: '6988054982.b99bc0a.1a4f12af6879492583cb62448700be06',
    ...
    var $buythemediv = '<div class="all-demo alt-font sm-display-none"><a href="mailto:info@splashink.co?subject=Subscição para newsletter"><i class="ti-email"></i><span>Escreva-nos</span></a></div>';
